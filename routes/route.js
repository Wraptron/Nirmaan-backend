...
router.post("/resumeupload", uploadLimiter, requireRole(2, 5), ResumeUpload);
...
router.post("/addstartup/award", requireRole(2, 5), uploadLimiter, upload.single("document"), AddAward);
router.get("/fetchaward", requireRole(2, 5), FetchAwardData);
router.delete("/delete-award/:id", requireRole(2, 5), DeleteAward);
router.put("/updateaward", requireRole(2, 5), uploadLimiter, upload.single("document"), UpdateAward);
...
router.post("/ipdataupload", requireRole(2), uploadLimiter, upload.single("file"), IPdataUpload);
